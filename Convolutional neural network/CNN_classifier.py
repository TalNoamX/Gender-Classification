...
def main():
    ...
    with open(r'C:\Users\user1\PycharmProjects\gender-classification-1\CNN\model\saved_model_250ep_w_dropout_data_rich.json', 'w') as outfile:
        json.dump(json.loads(json_str), outfile, indent=4)  # Save the json on a file
        model.save_weights(r"C:\Users\user1\PycharmProjects\gender-classification-1\CNN\model\weights_250ep_w_dropout_data_rich.h5", save_format="h5")
